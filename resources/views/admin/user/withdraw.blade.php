...
@endif 
    <div class="panel panel-info">
        <div class="panel-heading">
            <div class="panel-title">{{__('shop.Manual withdrawal')}}</div>
        </div>
            ...
            <form method="POST" action="{{route('adminUser.postWithdraw')}}" class="form-horizontal" enctype="multipart/form-data" role="form">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="neam">{{__('shop.Account Name')}}</label>
                    ...
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="withdraw">{{__('shop.withdraw')}}</label>
                        <div class="col-md-2">
