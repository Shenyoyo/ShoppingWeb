...
<div class="row ">
  <div class="col-xs-12">
    <div class="btn-group pull-right" style="margin-bottom: 10px">
      <a href="{{route('adminContact.index')}}" class="btn btn-sm btn-default"><i class="fa fa-list"></i>
        ...
        <section class="comment-list">
            ...
            <div class="col-md-2 col-sm-2 hidden-xs">
              <figure class="thumbnail">
                <img class="img-responsive"
                  src="https://icons.iconarchive.com/icons/icons8/windows-8/64/Users-Name-icon.png" />
          ...
          <article class="row">
            ...
            <div class="col-md-2 col-sm-2 hidden-xs">
              <figure class="thumbnail">
                <img class="img-responsive"
                  src="https://icons.iconarchive.com/icons/icons8/windows-8/64/Users-Administrator-icon.png" />
...
<form role="form" action="{{route('adminContact.reply')}}" method="POST">
  ...
  <div class="form-group">
    ...
    <input style="width: 10%" id="name" name="name" type="text" class="form-control"
