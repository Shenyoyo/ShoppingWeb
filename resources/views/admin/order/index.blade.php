...
           </thead>
    ...
                       <td>
                       @if ($order->status == '1')
                       <a href="{{route('order.sand',['id' => $order->id ])}}"><button class="btn btn-success">送貨</button></a> 
                       <a href="{{route('order.show',['id' => $order->id ])}}"><button class="btn btn-primary">明細</button></a> 
                       @else
                       <a href="{{route('order.show',['id' => $order->id ])}}"><button class="btn btn-primary">明細</button></a>     
                       @endif
